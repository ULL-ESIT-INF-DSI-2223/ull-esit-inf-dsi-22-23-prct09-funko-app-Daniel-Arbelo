...
export class FilterMapSubReduce extends Template{

    /**
     * Constructr de la clase FilterMapSubReduce
    ...
    /**
     * funcion que un valor inicial acumula el resulad de restarle cada elemnto de la lista
