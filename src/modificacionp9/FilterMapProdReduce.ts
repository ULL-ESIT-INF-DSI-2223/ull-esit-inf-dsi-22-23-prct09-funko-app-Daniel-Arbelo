...
export class FilterMapProdReduce extends Template{

    /**
     * Constructr de la clase FilterMapProdReduce
    ...
    /**
     * funcion que un valor inicial acumula el resulad de multiplicarle cada elemnto de la lista
