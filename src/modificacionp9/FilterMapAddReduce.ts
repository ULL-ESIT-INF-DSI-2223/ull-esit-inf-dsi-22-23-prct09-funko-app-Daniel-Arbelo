...
export class FilterMapAddReduce extends Template{

    /**
     * Constructr de la clase FilterMapAddReduce
    ...
    /**
     * funcion que un valor inicial acumula el resulado de sumarle cada elemnto de la lista
